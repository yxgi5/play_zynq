...
module bd_2d50_csc_0_MultiPixStream2AXIvi (
        ...
        ap_idle,
        ap_ready,
        stream_out_vresample_3_dout,
        stream_out_vresample_3_empty_n,
        stream_out_vresample_3_read,
        stream_out_vresample_4_dout,
        stream_out_vresample_4_empty_n,
        stream_out_vresample_4_read,
        stream_out_vresample_5_dout,
        stream_out_vresample_5_empty_n,
        stream_out_vresample_5_read,
        m_axis_video_TDATA,
        m_axis_video_TVALID,
        m_axis_video_TREADY,
        m_axis_video_TKEEP,
...
output   ap_idle;
output   ap_ready;
input  [7:0] stream_out_vresample_3_dout;
input   stream_out_vresample_3_empty_n;
output   stream_out_vresample_3_read;
input  [7:0] stream_out_vresample_4_dout;
input   stream_out_vresample_4_empty_n;
output   stream_out_vresample_4_read;
input  [7:0] stream_out_vresample_5_dout;
input   stream_out_vresample_5_empty_n;
output   stream_out_vresample_5_read;
...
reg    stream_out_vresample_3_blk_n;
wire    ap_CS_fsm_pp0_stage0;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0;
reg   [0:0] exitcond1_i_i_reg_488;
reg    stream_out_vresample_4_blk_n;
reg    stream_out_vresample_5_blk_n;
reg    m_axis_video_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] exitcond1_i_i_reg_488_pp0_iter1_reg;
...
reg   [11:0] tmp_i_i_73_reg_469;
wire   [11:0] tmp_71_i_i_fu_284_p2;
reg   [11:0] tmp_71_i_i_reg_474;
wire   [0:0] exitcond_i_i_fu_290_p2;
wire    ap_CS_fsm_state3;
reg    ap_block_state3;
wire   [11:0] i_fu_295_p2;
reg   [11:0] i_reg_483;
wire   [0:0] exitcond1_i_i_fu_301_p2;
wire    ap_block_state4_pp0_stage0_iter0;
wire    stream_out_vresample_30_status;
...
reg    stream_out_vresample_30_update;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((m_axis_video_V_data_V_1_ack_in == 1'b0) | (m_axis_video_V_dest_V_1_ack_in == 1'b0) | (m_axis_video_V_id_V_1_ack_in == 1'b0) | (m_axis_video_V_last_V_1_ack_in == 1'b0) | (m_axis_video_V_user_V_1_ack_in == 1'b0) | (m_axis_video_V_strb_V_1_ack_in == 1'b0) | (m_axis_video_V_keep_V_1_ack_in == 1'b0)) & (exitcond_i_i_fu_290_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((~((m_axis_video_V_data_V_1_ack_in == 1'b0) | (m_axis_video_V_dest_V_1_ack_in == 1'b0) | (m_axis_video_V_id_V_1_ack_in == 1'b0) | (m_axis_video_V_last_V_1_ack_in == 1'b0) | (m_axis_video_V_user_V_1_ack_in == 1'b0) | (m_axis_video_V_strb_V_1_ack_in == 1'b0) | (m_axis_video_V_keep_V_1_ack_in == 1'b0)) & (exitcond_i_i_fu_290_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        j_i_i_reg_212 <= 12'd0;
    end else if (((exitcond1_i_i_fu_301_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_i_i_reg_212 <= j_fu_306_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_i_i_reg_488 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond1_i_i_reg_488 <= exitcond1_i_i_fu_301_p2;
        exitcond1_i_i_reg_488_pp0_iter1_reg <= exitcond1_i_i_reg_488;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_71_i_i_reg_474 <= tmp_71_i_i_fu_284_p2;
        tmp_i_i_73_reg_469 <= grp_reg_unsigned_short_s_fu_273_ap_return;
        tmp_i_i_reg_464 <= grp_reg_unsigned_short_s_fu_267_ap_return;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_i_i_fu_301_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_497 <= tmp_last_V_fu_312_p2;
    end
end

always @ (*) begin
    if ((exitcond1_i_i_fu_301_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_466)) begin
        if ((8'd0 == HwReg_OutVideoFormat_2_read_fu_156_p2)) begin
            ...
            ap_phi_mux_p_088_0_2_0_1_i_i_phi_fu_237_p6 = p_Result_9_0_1_i_i_fu_356_p5;
        end else if ((~(8'd1 == HwReg_OutVideoFormat_2_read_fu_156_p2) & ~(8'd0 == HwReg_OutVideoFormat_2_read_fu_156_p2))) begin
            ap_phi_mux_p_088_0_2_0_1_i_i_phi_fu_237_p6 = p_Result_10_0_1_i_s_fu_382_p5;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_466)) begin
        if ((8'd0 == HwReg_OutVideoFormat_2_read_fu_156_p2)) begin
            ...
            ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6 = p_Result_9_0_i_i_fu_329_p3;
        end else if ((~(8'd1 == HwReg_OutVideoFormat_2_read_fu_156_p2) & ~(8'd0 == HwReg_OutVideoFormat_2_read_fu_156_p2))) begin
            ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6 = p_Result_10_0_i_i_fu_347_p3;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_466)) begin
        if ((8'd0 == HwReg_OutVideoFormat_2_read_fu_156_p2)) begin
            ...
            ap_phi_mux_tmp_data_V_phi_fu_249_p6 = p_Result_9_0_2_i_i_fu_395_p5;
        end else if ((~(8'd1 == HwReg_OutVideoFormat_2_read_fu_156_p2) & ~(8'd0 == HwReg_OutVideoFormat_2_read_fu_156_p2))) begin
            ap_phi_mux_tmp_data_V_phi_fu_249_p6 = p_Result_10_0_2_i_s_fu_421_p5;
        end else begin
...
always @ (*) begin
    if ((((exitcond1_i_i_reg_488_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond1_i_i_reg_488 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((exitcond1_i_i_reg_488 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        stream_out_vresample_30_update = 1'b1;
    end else begin
        stream_out_vresample_30_update = 1'b0;
    end
end

always @ (*) begin
    if (((exitcond1_i_i_reg_488 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        stream_out_vresample_3_blk_n = stream_out_vresample_3_empty_n;
    end else begin
        stream_out_vresample_3_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((exitcond1_i_i_reg_488 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        stream_out_vresample_4_blk_n = stream_out_vresample_4_empty_n;
    end else begin
        stream_out_vresample_4_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((exitcond1_i_i_reg_488 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        stream_out_vresample_5_blk_n = stream_out_vresample_5_empty_n;
    end else begin
        stream_out_vresample_5_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond1_i_i_fu_301_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond1_i_i_fu_301_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond1_i_i_reg_488 == 1'd0) & (stream_out_vresample_30_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((exitcond1_i_i_reg_488 == 1'd0) & (stream_out_vresample_30_status == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((exitcond1_i_i_reg_488 == 1'd0) & (stream_out_vresample_30_status == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state5_io = ((exitcond1_i_i_reg_488 == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((exitcond1_i_i_reg_488 == 1'd0) & (stream_out_vresample_30_status == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((exitcond1_i_i_reg_488_pp0_iter1_reg == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state6_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_condition_466 = ((exitcond1_i_i_reg_488 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign exitcond1_i_i_fu_301_p2 = ((j_i_i_reg_212 == tmp_i_i_73_reg_469) ? 1'b1 : 1'b0);

assign exitcond_i_i_fu_290_p2 = ((i_i_i_reg_201 == tmp_i_i_reg_464) ? 1'b1 : 1'b0);
...
assign p_Result_0_1_i_i_fu_369_p5 = {{ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6[23:16]}, {stream_out_vresample_5_dout}, {ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6[7:0]}};

assign p_Result_0_2_i_i_fu_408_p5 = {{stream_out_vresample_3_dout}, {ap_phi_mux_p_088_0_2_0_1_i_i_phi_fu_237_p6[15:0]}};

assign p_Result_0_i_i_fu_338_p3 = {{16'd65535}, {stream_out_vresample_4_dout}};

assign p_Result_10_0_1_i_s_fu_382_p5 = {{ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6[23:16]}, {stream_out_vresample_4_dout}, {ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6[7:0]}};

assign p_Result_10_0_2_i_s_fu_421_p5 = {{stream_out_vresample_5_dout}, {ap_phi_mux_p_088_0_2_0_1_i_i_phi_fu_237_p6[15:0]}};

assign p_Result_10_0_i_i_fu_347_p3 = {{16'd65535}, {stream_out_vresample_3_dout}};

assign p_Result_9_0_1_i_i_fu_356_p5 = {{ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6[23:16]}, {stream_out_vresample_4_dout}, {ap_phi_mux_p_088_0_2_0_i_i_phi_fu_226_p6[7:0]}};

assign p_Result_9_0_2_i_i_fu_395_p5 = {{stream_out_vresample_5_dout}, {ap_phi_mux_p_088_0_2_0_1_i_i_phi_fu_237_p6[15:0]}};

assign p_Result_9_0_i_i_fu_329_p3 = {{16'd65535}, {stream_out_vresample_3_dout}};

assign stream_out_vresample_30_status = (stream_out_vresample_5_empty_n & stream_out_vresample_4_empty_n & stream_out_vresample_3_empty_n);

assign stream_out_vresample_3_read = stream_out_vresample_30_update;

assign stream_out_vresample_4_read = stream_out_vresample_30_update;

assign stream_out_vresample_5_read = stream_out_vresample_30_update;

assign tmp_71_i_i_fu_284_p2 = ($signed(12'd4095) + $signed(grp_reg_unsigned_short_s_fu_273_ap_return));

assign tmp_last_V_fu_312_p2 = ((j_i_i_reg_212 == tmp_71_i_i_reg_474) ? 1'b1 : 1'b0);
