...
# B0
set_property PACKAGE_PIN H22 [get_ports {hdmi_d[8]}]
# B1
set_property PACKAGE_PIN G22 [get_ports {hdmi_d[9]}]
# B2
set_property PACKAGE_PIN G17 [get_ports {hdmi_d[10]}]
# B3
set_property PACKAGE_PIN F17 [get_ports {hdmi_d[11]}]
# B4
set_property PACKAGE_PIN G15 [get_ports {hdmi_d[12]}]
# B5
set_property PACKAGE_PIN D15 [get_ports {hdmi_d[13]}]
# B6
set_property PACKAGE_PIN E15 [get_ports {hdmi_d[14]}]
# B7
set_property PACKAGE_PIN F18 [get_ports {hdmi_d[15]}]
# G0
set_property PACKAGE_PIN E18 [get_ports {hdmi_d[0]}]
# G1
set_property PACKAGE_PIN H17 [get_ports {hdmi_d[1]}]
# G2
set_property PACKAGE_PIN H18 [get_ports {hdmi_d[2]}]
# G3
set_property PACKAGE_PIN H19 [get_ports {hdmi_d[3]}]
# G4
set_property PACKAGE_PIN H20 [get_ports {hdmi_d[4]}]
# G5
set_property PACKAGE_PIN G19 [get_ports {hdmi_d[5]}]
# G6
set_property PACKAGE_PIN F19 [get_ports {hdmi_d[6]}]
# G7
set_property PACKAGE_PIN G20 [get_ports {hdmi_d[7]}]
# R0
...
#set_property PACKAGE_PIN G20 [get_ports {hdmi_d[7]}]
# Cb0/Cr0
#set_property PACKAGE_PIN G21 [get_ports {hdmi_d[8]}]
# Cb1/Cr1
#set_property PACKAGE_PIN F21 [get_ports {hdmi_d[9]}]
# Cb2/Cr2
#set_property PACKAGE_PIN F22 [get_ports {hdmi_d[10]}]
# Cb3/Cr3
#set_property PACKAGE_PIN E21 [get_ports {hdmi_d[11]}]
# Cb4/Cr4
#set_property PACKAGE_PIN D21 [get_ports {hdmi_d[12]}]
# Cb5/Cr5
#set_property PACKAGE_PIN D22 [get_ports {hdmi_d[13]}]
# Cb6/Cr6
#set_property PACKAGE_PIN C22 [get_ports {hdmi_d[14]}]
# Cb7/Cr7
#set_property PACKAGE_PIN B21 [get_ports {hdmi_d[15]}]
