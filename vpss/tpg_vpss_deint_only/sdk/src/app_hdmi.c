...
*
******************************************************************************/
void app_hdmi_conf_tpg_interlaced(XV_tpg *InstancePtr, _Bool isInterlaced)
{
	// Configure interlaced (1) or progressive mode (0)
	XV_tpg_Set_Interlaced(InstancePtr, isInterlaced);
}
