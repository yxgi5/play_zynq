...
HD_PWD='/home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axi_smc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_smc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_smc_3.tcl
