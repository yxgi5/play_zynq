...
read_ip -quiet /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3.xci
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axi_smc_3_synth_1 -new_name system_axi_smc_3 -ip [get_ips system_axi_smc_3]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top system_axi_smc_3 -part xc7z020clg484-2 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix system_axi_smc_3_ system_axi_smc_3.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_axi_smc_3_stub.v
 lappend ipCachedFiles system_axi_smc_3_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_axi_smc_3_stub.vhdl
 lappend ipCachedFiles system_axi_smc_3_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_axi_smc_3_sim_netlist.v
 lappend ipCachedFiles system_axi_smc_3_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_axi_smc_3_sim_netlist.vhdl
 lappend ipCachedFiles system_axi_smc_3_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp system_axi_smc_3.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips system_axi_smc_3]
}

rename_ref -prefix_all system_axi_smc_3_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef system_axi_smc_3.dcp
create_report "system_axi_smc_3_synth_1_synth_report_utilization_0" "report_utilization -file system_axi_smc_3_utilization_synth.rpt -pb system_axi_smc_3_utilization_synth.pb"

if { [catch {
  file copy -force /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axi_smc_3_synth_1/system_axi_smc_3.dcp /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axi_smc_3_synth_1/system_axi_smc_3_stub.v /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axi_smc_3_synth_1/system_axi_smc_3_stub.vhdl /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axi_smc_3_synth_1/system_axi_smc_3_sim_netlist.v /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axi_smc_3_synth_1/system_axi_smc_3_sim_netlist.vhdl /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.ip_user_files/ip/system_axi_smc_3]} {
  catch { 
    file copy -force /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_stub.v /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.ip_user_files/ip/system_axi_smc_3
  }
}

if {[file isdir /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.ip_user_files/ip/system_axi_smc_3]} {
  catch { 
    file copy -force /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.srcs/sources_1/bd/system/ip/system_axi_smc_3/system_axi_smc_3_stub.vhdl /home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.ip_user_files/ip/system_axi_smc_3
  }
}
