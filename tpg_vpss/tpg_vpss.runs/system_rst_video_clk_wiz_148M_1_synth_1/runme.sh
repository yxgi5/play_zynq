...
HD_PWD='/home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_rst_video_clk_wiz_148M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_video_clk_wiz_148M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_video_clk_wiz_148M_1.tcl
