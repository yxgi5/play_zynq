...
HD_PWD='/home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/bd_2d50_hcr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_2d50_hcr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_2d50_hcr_0.tcl
