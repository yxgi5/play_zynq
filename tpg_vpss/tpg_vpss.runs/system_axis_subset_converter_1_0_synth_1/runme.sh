...
HD_PWD='/home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_axis_subset_converter_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axis_subset_converter_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axis_subset_converter_1_0.tcl
