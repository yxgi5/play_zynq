...
HD_PWD='/home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_rst_ps7_0_100M_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_ps7_0_100M_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_ps7_0_100M_7.tcl
