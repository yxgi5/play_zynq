...
HD_PWD='/home/andy/zynq/play_zynq/tpg_vpss/tpg_vpss.runs/system_v_proc_ss_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_v_proc_ss_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_v_proc_ss_0_0.tcl
