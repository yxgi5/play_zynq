...
module bd_2d50_vcr_o_0_MultiPixStream2AXIvi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_idle,
        ap_ready,
        dstYUV_V_val_0_V_dout,
        dstYUV_V_val_0_V_empty_n,
        dstYUV_V_val_0_V_read,
        dstYUV_V_val_1_V_dout,
        dstYUV_V_val_1_V_empty_n,
        dstYUV_V_val_1_V_read,
        dstYUV_V_val_2_V_dout,
        dstYUV_V_val_2_V_empty_n,
        dstYUV_V_val_2_V_read,
        m_axis_video_TDATA,
        m_axis_video_TVALID,
        m_axis_video_TREADY,
        m_axis_video_TKEEP,
...
output   ap_idle;
output   ap_ready;
input  [7:0] dstYUV_V_val_0_V_dout;
input   dstYUV_V_val_0_V_empty_n;
output   dstYUV_V_val_0_V_read;
input  [7:0] dstYUV_V_val_1_V_dout;
input   dstYUV_V_val_1_V_empty_n;
output   dstYUV_V_val_1_V_read;
input  [7:0] dstYUV_V_val_2_V_dout;
input   dstYUV_V_val_2_V_empty_n;
output   dstYUV_V_val_2_V_read;
...
reg    dstYUV_V_val_0_V_blk_n;
wire    ap_CS_fsm_pp0_stage0;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0;
reg   [0:0] exitcond1_i_i_reg_330;
reg    dstYUV_V_val_1_V_blk_n;
reg    dstYUV_V_val_2_V_blk_n;
...
reg   [11:0] tmp_i_i_47_reg_311;
wire   [11:0] tmp_26_i_i_fu_224_p2;
reg   [11:0] tmp_26_i_i_reg_316;
wire   [0:0] exitcond_i_i_fu_230_p2;
...
bd_2d50_vcr_o_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_207(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
bd_2d50_vcr_o_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_213(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((m_axis_video_V_data_V_1_ack_in == 1'b0) | (m_axis_video_V_dest_V_1_ack_in == 1'b0) | (m_axis_video_V_id_V_1_ack_in == 1'b0) | (m_axis_video_V_last_V_1_ack_in == 1'b0) | (m_axis_video_V_user_V_1_ack_in == 1'b0) | (m_axis_video_V_strb_V_1_ack_in == 1'b0) | (m_axis_video_V_keep_V_1_ack_in == 1'b0)) & (exitcond_i_i_fu_230_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_26_i_i_reg_316 <= tmp_26_i_i_fu_224_p2;
        tmp_i_i_47_reg_311 <= grp_reg_unsigned_short_s_fu_213_ap_return;
...
always @ (*) begin
    if (((exitcond1_i_i_reg_330 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dstYUV_V_val_0_V0_update = 1'b1;
    end else begin
        dstYUV_V_val_0_V0_update = 1'b0;
    end
end

always @ (*) begin
    if (((exitcond1_i_i_reg_330 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dstYUV_V_val_0_V_blk_n = dstYUV_V_val_0_V_empty_n;
    end else begin
        dstYUV_V_val_0_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((exitcond1_i_i_reg_330 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dstYUV_V_val_1_V_blk_n = dstYUV_V_val_1_V_empty_n;
    end else begin
        dstYUV_V_val_1_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((exitcond1_i_i_reg_330 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dstYUV_V_val_2_V_blk_n = dstYUV_V_val_2_V_empty_n;
    end else begin
        dstYUV_V_val_2_V_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond1_i_i_reg_330 == 1'd0) & (dstYUV_V_val_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((exitcond1_i_i_reg_330 == 1'd0) & (dstYUV_V_val_0_V0_status == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((exitcond1_i_i_reg_330 == 1'd0) & (dstYUV_V_val_0_V0_status == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((exitcond1_i_i_reg_330 == 1'd0) & (dstYUV_V_val_0_V0_status == 1'b0));
end
...
assign dstYUV_V_val_0_V0_status = (dstYUV_V_val_2_V_empty_n & dstYUV_V_val_1_V_empty_n & dstYUV_V_val_0_V_empty_n);

assign dstYUV_V_val_0_V_read = dstYUV_V_val_0_V0_update;

assign dstYUV_V_val_1_V_read = dstYUV_V_val_0_V0_update;

assign dstYUV_V_val_2_V_read = dstYUV_V_val_0_V0_update;

assign exitcond1_i_i_fu_241_p2 = ((j_i_i_reg_188 == tmp_i_i_47_reg_311) ? 1'b1 : 1'b0);

assign exitcond_i_i_fu_230_p2 = ((i_i_i_reg_177 == tmp_i_i_reg_306) ? 1'b1 : 1'b0);
...
assign tmp_26_i_i_fu_224_p2 = ($signed(12'd4095) + $signed(grp_reg_unsigned_short_s_fu_213_ap_return));

assign tmp_data_V_fu_273_p4 = {{{dstYUV_V_val_2_V_dout}, {dstYUV_V_val_1_V_dout}}, {dstYUV_V_val_0_V_dout}};

assign tmp_last_V_fu_252_p2 = ((j_i_i_reg_188 == tmp_26_i_i_reg_316) ? 1'b1 : 1'b0);

endmodule //bd_2d50_vcr_o_0_MultiPixStream2AXIvi
