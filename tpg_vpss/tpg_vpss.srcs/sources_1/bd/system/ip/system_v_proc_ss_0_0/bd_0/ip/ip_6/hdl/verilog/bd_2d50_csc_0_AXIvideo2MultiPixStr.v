...
module bd_2d50_csc_0_AXIvideo2MultiPixStr (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        stream_in_V_val_0_V_full_n,
        stream_in_V_val_0_V_write,
        stream_in_V_val_1_V_din,
        stream_in_V_val_1_V_full_n,
        stream_in_V_val_1_V_write,
        stream_in_V_val_2_V_din,
        stream_in_V_val_2_V_full_n,
        stream_in_V_val_2_V_write,
        HwReg_height,
        HwReg_width,
        HwReg_InVideoFormat
);
...
output  [7:0] stream_in_V_val_0_V_din;
input   stream_in_V_val_0_V_full_n;
output   stream_in_V_val_0_V_write;
output  [7:0] stream_in_V_val_1_V_din;
input   stream_in_V_val_1_V_full_n;
output   stream_in_V_val_1_V_write;
output  [7:0] stream_in_V_val_2_V_din;
input   stream_in_V_val_2_V_full_n;
output   stream_in_V_val_2_V_write;
input  [15:0] HwReg_height;
input  [15:0] HwReg_width;
input  [7:0] HwReg_InVideoFormat;
...
wire   [0:0] exitcond1_i_i_fu_377_p2;
wire   [0:0] brmerge_i_i_fu_391_p2;
wire    ap_CS_fsm_state9;
wire   [0:0] ap_phi_mux_eol_2_i_i_phi_fu_315_p4;
reg    stream_in_V_val_0_V_blk_n;
reg    ap_enable_reg_pp1_iter1;
reg   [0:0] exitcond1_i_i_reg_508;
reg    stream_in_V_val_1_V_blk_n;
reg    stream_in_V_val_2_V_blk_n;
reg   [0:0] eol_reg_218;
...
reg    stream_in_V_val_0_V1_update;
...
bd_2d50_csc_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_340(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
bd_2d50_csc_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_346(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond9_i_i_fu_366_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state6) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond9_i_i_fu_366_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond1_i_i_reg_508 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_582)) begin
        if (((brmerge_i_i_fu_391_p2 == 1'd1) & (exitcond1_i_i_fu_377_p2 == 1'd0))) begin
            axi_last_V_2_i_i_reg_263 <= ap_phi_mux_eol_phi_fu_221_p4;
        end else if (((brmerge_i_i_fu_391_p2 == 1'd0) & (exitcond1_i_i_fu_377_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond1_i_i_fu_377_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        exitcond1_i_i_reg_508 <= exitcond1_i_i_fu_377_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_i_i_64_reg_467 <= grp_reg_unsigned_short_s_fu_346_ap_return;
        tmp_i_i_reg_462 <= grp_reg_unsigned_short_s_fu_340_ap_return;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond1_i_i_fu_377_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((exitcond1_i_i_fu_377_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond9_i_i_fu_366_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((exitcond1_i_i_reg_508 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((eol_2_i_i_reg_312 == 1'd0) & (1'b1 == ap_CS_fsm_state9)) | ((brmerge_i_i_fu_391_p2 == 1'd0) & (exitcond1_i_i_fu_377_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond1_i_i_reg_508 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        stream_in_V_val_0_V1_update = 1'b1;
    end else begin
        stream_in_V_val_0_V1_update = 1'b0;
    end
end
...
always @ (*) begin
    if (((exitcond1_i_i_reg_508 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        stream_in_V_val_0_V_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    if (((exitcond1_i_i_reg_508 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        stream_in_V_val_1_V_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    if (((exitcond1_i_i_reg_508 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        stream_in_V_val_2_V_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond1_i_i_fu_377_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond1_i_i_fu_377_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((exitcond1_i_i_reg_508 == 1'd0) & (stream_in_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op61_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((exitcond1_i_i_reg_508 == 1'd0) & (stream_in_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op61_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((exitcond1_i_i_reg_508 == 1'd0) & (stream_in_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op61_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state7_pp1_stage0_iter1 = ((exitcond1_i_i_reg_508 == 1'd0) & (stream_in_V_val_0_V1_status == 1'b0));
end
...
always @ (*) begin
    ap_condition_673 = ((exitcond1_i_i_fu_377_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
always @ (*) begin
    ap_predicate_op61_read_state6 = ((brmerge_i_i_fu_391_p2 == 1'd0) & (exitcond1_i_i_fu_377_p2 == 1'd0));
end

assign brmerge_i_i_fu_391_p2 = (sof_1_i_i_fu_134 | ap_phi_mux_eol_i_i_phi_fu_244_p4);

assign exitcond1_i_i_fu_377_p2 = ((j_i_i_reg_252 == tmp_i_i_64_reg_467) ? 1'b1 : 1'b0);

assign exitcond9_i_i_fu_366_p2 = ((i_i_i_reg_207 == tmp_i_i_reg_462) ? 1'b1 : 1'b0);

assign grp_reg_unsigned_short_s_fu_340_ap_start = grp_reg_unsigned_short_s_fu_340_ap_start_reg;

assign grp_reg_unsigned_short_s_fu_340_in_r = HwReg_height[11:0];
...
assign sel_tmp2_i_fu_356_p2 = ((HwReg_InVideoFormat == 8'd0) ? 1'b1 : 1'b0);

assign stream_in_V_val_0_V1_status = (stream_in_V_val_2_V_full_n & stream_in_V_val_1_V_full_n & stream_in_V_val_0_V_full_n);

assign stream_in_V_val_0_V_din = tmp_val_0_V_reg_531;

assign stream_in_V_val_0_V_write = stream_in_V_val_0_V1_update;

assign stream_in_V_val_1_V_din = tmp_val_1_V_reg_526;

assign stream_in_V_val_1_V_write = stream_in_V_val_0_V1_update;

assign stream_in_V_val_2_V_din = tmp_val_2_V_reg_521;

assign stream_in_V_val_2_V_write = stream_in_V_val_0_V1_update;
...
endmodule //bd_2d50_csc_0_AXIvideo2MultiPixStr
