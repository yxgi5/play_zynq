// ==============================================================
// File generated on Sat Apr 24 21:18:54 CST 2021
...
// ==============================================================
`timescale 1ns/1ps
module bd_2d50_vcr_i_0_v_vcresampler_CTRL_s_axi
#(parameter
    ...
    output wire [15:0]                   HwReg_input_video_format,
    output wire [15:0]                   HwReg_output_video_format,
...
//------------------------Local signal-------------------
    ...
    reg  [15:0]                   int_HwReg_input_video_format = 'b0;
    reg  [15:0]                   int_HwReg_output_video_format = 'b0;
        ...
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_HWREG_INPUT_VIDEO_FORMAT_DATA_0: begin
                    rdata <= int_HwReg_input_video_format[15:0];
                end
                ADDR_HWREG_OUTPUT_VIDEO_FORMAT_DATA_0: begin
                    rdata <= int_HwReg_output_video_format[15:0];
                end
...
// int_HwReg_input_video_format[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_HwReg_input_video_format[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_HWREG_INPUT_VIDEO_FORMAT_DATA_0)
            int_HwReg_input_video_format[15:0] <= (WDATA[31:0] & wmask) | (int_HwReg_input_video_format[15:0] & ~wmask);
    end
end

// int_HwReg_output_video_format[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_HwReg_output_video_format[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_HWREG_OUTPUT_VIDEO_FORMAT_DATA_0)
            int_HwReg_output_video_format[15:0] <= (WDATA[31:0] & wmask) | (int_HwReg_output_video_format[15:0] & ~wmask);
    end
end
