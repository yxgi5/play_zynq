...
module bd_2d50_hsc_0_MultiPixStream2AXIvi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
bd_2d50_hsc_0_MultiPixStream2AXIvi_mapComp #(
    .DataWidth( 2 ),
    .AddressRange( 12 ),
    .AddressWidth( 4 ))
mapComp_U(
...
bd_2d50_hsc_0_v_hscaler_mux_32_8_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 8 ),
...
endmodule //bd_2d50_hsc_0_MultiPixStream2AXIvi
