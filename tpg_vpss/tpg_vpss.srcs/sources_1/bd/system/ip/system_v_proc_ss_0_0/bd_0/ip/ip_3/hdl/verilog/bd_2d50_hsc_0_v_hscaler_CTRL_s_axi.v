// ==============================================================
// File generated on Sat Apr 24 21:11:00 CST 2021
...
// ==============================================================
`timescale 1ns/1ps
module bd_2d50_hsc_0_v_hscaler_CTRL_s_axi
#(parameter
...
//------------------------Instantiation------------------
// int_HwReg_hfltCoeff
bd_2d50_hsc_0_v_hscaler_CTRL_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 192 )
) int_HwReg_hfltCoeff (
    .clk0     ( ACLK ),
...
module bd_2d50_hsc_0_v_hscaler_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
