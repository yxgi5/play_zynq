...
################################################################
# This is a generated script based on design: bd_45a3
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SC_RDATA_WIDTH {256} \
   CONFIG.SC_RUSER_BITS_PER_BYTE {0} \
   CONFIG.SC_WDATA_WIDTH {256} \
