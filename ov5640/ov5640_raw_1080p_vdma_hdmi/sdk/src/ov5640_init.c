...
//		   sccb_write_reg16(0x380c, 0x09); /* Total horizontal size, 2500 */
//		   sccb_write_reg16(0x380d, 0xc4);
//		   sccb_write_reg16(0x380e, 0x05); /* Total vertical size, 1280 */
//		   sccb_write_reg16(0x380f, 0x00);
...
//		   sccb_write_reg16(0x380b, 0xa0);
		   sccb_write_reg16(0x3808, 0x07); /* DVP output horizontal width, 1920 */
		   sccb_write_reg16(0x3809, 0x80);
		   sccb_write_reg16(0x380a, 0x04); /* DVP output horizontal width, 1080 */
		   sccb_write_reg16(0x380b, 0x38);
...
//		   sccb_write_reg16(0x3802, 0x00); /*  Y Address start */
//		   sccb_write_reg16(0x3803, 0x00);
//		   sccb_write_reg16(0x3804, 0x09); /*  X Address end */
//		   sccb_write_reg16(0x3805, 0xd3);
//		   sccb_write_reg16(0x3806, 0x04); /*  Y Address end */
//		   sccb_write_reg16(0x3807, 0x3c);
