...
HD_PWD='/home/andy/zynq/play_zynq/raw_ov5640_colorbar_vdma_hdmi/raw_ov5640_colorbar_vdma_hdmi.runs/design_1_axis_switch_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_switch_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_switch_0_0.tcl
