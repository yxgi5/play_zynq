// ==============================================================
// File generated on Sun Apr 25 16:04:49 CST 2021
...
// ==============================================================
`timescale 1ns/1ps
module bd_ed91_hsc_0_v_hscaler_CTRL_s_axi
#(parameter
...
// 0x2000 ~
// 0x3fff : Memory 'HwReg_phasesH_V' (3840 * 9b)
...
localparam
    ...
    ADDR_HWREG_COLORMODEOUT_DATA_0 = 14'h0038,
    ADDR_HWREG_COLORMODEOUT_CTRL   = 14'h003c,
    ADDR_HWREG_HFLTCOEFF_BASE      = 14'h0800,
    ADDR_HWREG_HFLTCOEFF_HIGH      = 14'h0bff,
...
//------------------------Instantiation------------------
// int_HwReg_hfltCoeff
bd_ed91_hsc_0_v_hscaler_CTRL_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 192 )
) int_HwReg_hfltCoeff (
    .clk0     ( ACLK ),
...
module bd_ed91_hsc_0_v_hscaler_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
