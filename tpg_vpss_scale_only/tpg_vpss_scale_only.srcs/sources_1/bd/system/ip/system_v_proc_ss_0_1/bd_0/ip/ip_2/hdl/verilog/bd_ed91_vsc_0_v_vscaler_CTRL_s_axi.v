...
// ==============================================================
`timescale 1ns/1ps
module bd_ed91_vsc_0_v_vscaler_CTRL_s_axi
#(parameter
...
// 0x034 : reserved
// 0x800 ~
// 0xbff : Memory 'HwReg_vfltCoeff' (384 * 16b)
...
//------------------------Instantiation------------------
// int_HwReg_vfltCoeff
bd_ed91_vsc_0_v_vscaler_CTRL_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 192 )
) int_HwReg_vfltCoeff (
    .clk0     ( ACLK ),
...
module bd_ed91_vsc_0_v_vscaler_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
