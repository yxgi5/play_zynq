...
module bd_ed91_hsc_0_hscale_core_polyphas (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
bd_ed91_hsc_0_hscale_core_polyphas_FiltCoeff_0_0 #(
    .DataWidth( 16 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
FiltCoeff_0_0_U(
...
bd_ed91_hsc_0_hscale_polyphase grp_hscale_polyphase_fu_651(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
bd_ed91_hsc_0_reg_ap_uint_9_s grp_reg_ap_uint_9_s_fu_834(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
endmodule //bd_ed91_hsc_0_hscale_core_polyphas
