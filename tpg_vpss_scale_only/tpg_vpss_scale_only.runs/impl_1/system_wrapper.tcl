...
set rc [catch {
  ...
  add_files -quiet /home/andreas/zynq/play_zynq/tpg_vpss_scale_only/tpg_vpss_scale_only.runs/synth_1/system_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top system_wrapper -part xc7z020clg484-2
  set_param project.isImplRun false
