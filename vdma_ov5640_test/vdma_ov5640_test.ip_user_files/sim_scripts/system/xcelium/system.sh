...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/58e2/hdl" \
       +incdir+"$ref_dir/../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/8713/hdl" \
       +incdir+"$ref_dir/../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/58e2/hdl" \
       +incdir+"../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/8713/hdl" \
       +incdir+"../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../vdma_test_to_flash.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
