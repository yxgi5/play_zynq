...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_subset_converter_2_M_AXIS] [get_bd_intf_pins axis_subset_converter_1/M_AXIS] [get_bd_intf_pins ila_1/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins mipi_csi2_tx_subsyst_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins v_tpg_0/s_axi_CTRL]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Detect_level_0/clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_2/clk] [get_bd_pins rst_video_clk_wiz/slowest_sync_clk] [get_bd_pins uihdmitx_0/PCLKX1_i] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net v_tpg_0_m_axis_video_TUSER [get_bd_pins v_tpg_0/m_axis_video_TUSER] [get_bd_pins xlconcat_1/In0]
