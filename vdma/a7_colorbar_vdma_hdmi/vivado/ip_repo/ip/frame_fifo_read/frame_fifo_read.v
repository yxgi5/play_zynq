...
(* keep =  "true" *)reg[ADDR_BITS - 1:0]                 read_cnt;                   //read data counter
...
(* keep =  "true" *)reg[3:0]                             state;                      //state machine
