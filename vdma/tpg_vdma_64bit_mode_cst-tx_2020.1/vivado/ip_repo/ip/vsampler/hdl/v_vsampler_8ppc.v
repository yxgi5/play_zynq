...
(* CORE_GENERATION_INFO="vsampler,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu2cg-sfvc784-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.715937,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=2730,HLS_SYN_LUT=991,HLS_VERSION=2018_3}" *)

module v_vsampler_8ppc #
(
...
reg   [0:0] tmp_5_reg_346;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] tmp_5_reg_346_pp0_iter1_reg;
reg   [61:0] indvar_flatten_reg_139;
reg   [30:0] i_reg_150;
reg   [28:0] j_reg_161;
wire   [29:0] tmp_fu_220_p3;
reg   [29:0] tmp_reg_322;
wire    ap_CS_fsm_state1;
wire   [61:0] bound_fu_236_p2;
reg   [61:0] bound_reg_327;
...
wire   [61:0] indvar_flatten_next_fu_256_p2;
wire   [30:0] i_cast1_mid2_v_fu_268_p3;
reg   [30:0] i_cast1_mid2_v_reg_341;
wire   [0:0] tmp_5_fu_276_p1;
reg   [M_AXIS_WIDTH-1:0] tmp_data_V_reg_350;
reg   [M_AXIS_BYTES -1:0] tmp_keep_V_reg_355;
reg   [M_AXIS_BYTES -1:0] tmp_strb_V_reg_360;
reg   [0:0] tmp_user_V_reg_365;
reg   [0:0] tmp_last_V_reg_370;
reg   [0:0] tmp_id_V_reg_375;
reg   [0:0] tmp_dest_V_reg_380;
wire   [28:0] j_1_fu_314_p3;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [30:0] ap_phi_mux_i_phi_fu_154_p4;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] p_neg_fu_180_p2;
wire   [28:0] tmp_1_fu_186_p4;
wire   [29:0] p_lshr_cast_fu_196_p1;
wire   [28:0] tmp_2_fu_206_p4;
wire   [0:0] tmp_3_fu_172_p3;
wire   [29:0] p_neg_t_fu_200_p2;
wire   [29:0] p_lshr_f_cast_fu_216_p1;
wire   [29:0] bound_fu_236_p0;
wire   [31:0] bound_fu_236_p1;
wire   [29:0] j_cast_fu_242_p1;
wire   [0:0] tmp_4_fu_246_p2;
wire   [30:0] i_s_fu_262_p2;
wire   [28:0] j_op_fu_308_p2;
reg   [2:0] ap_NS_fsm;
wire    ap_CS_fsm_state5;
reg    ap_block_state5;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [61:0] bound_fu_236_p00;
wire   [61:0] bound_fu_236_p10;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_reg_332 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_reg_150 <= i_cast1_mid2_v_reg_341;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        i_reg_150 <= 31'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_251_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten_reg_139 <= indvar_flatten_next_fu_256_p2;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        indvar_flatten_reg_139 <= 62'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_251_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_reg_161 <= j_1_fu_314_p3;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        j_reg_161 <= 29'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        bound_reg_327 <= bound_fu_236_p2;
        tmp_reg_322 <= tmp_fu_220_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond_flatten_reg_332 <= exitcond_flatten_fu_251_p2;
        tmp_5_reg_346_pp0_iter1_reg <= tmp_5_reg_346;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_251_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_cast1_mid2_v_reg_341 <= i_cast1_mid2_v_fu_268_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_A == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_A <= tmp_data_V_reg_350;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_B == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_B <= tmp_data_V_reg_350;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_dest_V_1_load_A == 1'b1)) begin
        m_axis_video_V_dest_V_1_payload_A <= tmp_dest_V_reg_380;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_dest_V_1_load_B == 1'b1)) begin
        m_axis_video_V_dest_V_1_payload_B <= tmp_dest_V_reg_380;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_id_V_1_load_A == 1'b1)) begin
        m_axis_video_V_id_V_1_payload_A <= tmp_id_V_reg_375;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_id_V_1_load_B == 1'b1)) begin
        m_axis_video_V_id_V_1_payload_B <= tmp_id_V_reg_375;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_keep_V_1_load_A == 1'b1)) begin
        m_axis_video_V_keep_V_1_payload_A <= tmp_keep_V_reg_355;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_keep_V_1_load_B == 1'b1)) begin
        m_axis_video_V_keep_V_1_payload_B <= tmp_keep_V_reg_355;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_A == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_A <= tmp_last_V_reg_370;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_B == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_B <= tmp_last_V_reg_370;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_strb_V_1_load_A == 1'b1)) begin
        m_axis_video_V_strb_V_1_payload_A <= tmp_strb_V_reg_360;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_strb_V_1_load_B == 1'b1)) begin
        m_axis_video_V_strb_V_1_payload_B <= tmp_strb_V_reg_360;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_A == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_A <= tmp_user_V_reg_365;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_B == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_B <= tmp_user_V_reg_365;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_251_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_5_reg_346 <= tmp_5_fu_276_p1;
        tmp_data_V_reg_350 <= s_axis_video_V_data_V_0_data_out;
        tmp_dest_V_reg_380 <= s_axis_video_V_dest_V_0_data_out;
        tmp_id_V_reg_375 <= s_axis_video_V_id_V_0_data_out;
        tmp_keep_V_reg_355 <= s_axis_video_V_keep_V_0_data_out;
        tmp_last_V_reg_370 <= s_axis_video_V_last_V_0_data_out;
        tmp_strb_V_reg_360 <= s_axis_video_V_strb_V_0_data_out;
        tmp_user_V_reg_365 <= s_axis_video_V_user_V_0_data_out;
    end
end

always @ (*) begin
    if ((exitcond_flatten_fu_251_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_reg_332 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_i_phi_fu_154_p4 = i_cast1_mid2_v_reg_341;
    end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (tmp_5_reg_346_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (tmp_5_reg_346 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_5_reg_346 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_fu_251_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_251_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_251_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_flatten_fu_251_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_251_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_251_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((exitcond_flatten_fu_251_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((tmp_5_reg_346 == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((tmp_5_reg_346_pp0_iter1_reg == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end
...
assign bound_fu_236_p00 = tmp_fu_220_p3;
...
assign exitcond_flatten_fu_251_p2 = ((indvar_flatten_reg_139 == bound_reg_327) ? 1'b1 : 1'b0);

assign i_cast1_mid2_v_fu_268_p3 = ((tmp_4_fu_246_p2[0:0] === 1'b1) ? ap_phi_mux_i_phi_fu_154_p4 : i_s_fu_262_p2);

assign i_s_fu_262_p2 = (31'd1 + ap_phi_mux_i_phi_fu_154_p4);

assign indvar_flatten_next_fu_256_p2 = (indvar_flatten_reg_139 + 62'd1);

assign j_1_fu_314_p3 = ((tmp_4_fu_246_p2[0:0] === 1'b1) ? j_op_fu_308_p2 : 29'd1);

assign j_cast_fu_242_p1 = j_reg_161;

assign j_op_fu_308_p2 = (j_reg_161 + 29'd1);
...
assign p_lshr_cast_fu_196_p1 = tmp_1_fu_186_p4;

assign p_lshr_f_cast_fu_216_p1 = tmp_2_fu_206_p4;

assign p_neg_fu_180_p2 = (32'd0 - hsize_in);

assign p_neg_t_fu_200_p2 = (30'd0 - p_lshr_cast_fu_196_p1);
...
assign tmp_1_fu_186_p4 = {{p_neg_fu_180_p2[31:3]}};

assign tmp_2_fu_206_p4 = {{hsize_in[31:3]}};

assign tmp_3_fu_172_p3 = hsize_in[32'd31];

assign tmp_4_fu_246_p2 = (($signed(j_cast_fu_242_p1) < $signed(tmp_reg_322)) ? 1'b1 : 1'b0);

assign tmp_5_fu_276_p1 = i_cast1_mid2_v_fu_268_p3[0:0];

assign tmp_fu_220_p3 = ((tmp_3_fu_172_p3[0:0] === 1'b1) ? p_neg_t_fu_200_p2 : p_lshr_f_cast_fu_216_p1);
