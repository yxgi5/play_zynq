...
wire   [63:0] bound_fu_166_p2;
reg   [63:0] bound_reg_257;
reg   [0:0] exitcond_flatten_reg_262;
...
wire   [63:0] indvar_flatten_next_fu_186_p2;
wire   [30:0] i_cast1_mid2_v_fu_198_p3;
reg   [30:0] i_cast1_mid2_v_reg_271;
wire   [0:0] tmp_fu_206_p1;
reg   [M_AXIS_WIDTH-1:0] tmp_data_V_reg_280;
reg   [M_AXIS_BYTES -1:0] tmp_keep_V_reg_285;
reg   [M_AXIS_BYTES -1:0] tmp_strb_V_reg_290;
reg   [0:0] tmp_user_V_reg_295;
reg   [0:0] tmp_last_V_reg_300;
reg   [0:0] tmp_id_V_reg_305;
reg   [0:0] tmp_dest_V_reg_310;
wire   [30:0] j_1_fu_244_p3;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [30:0] ap_phi_mux_i_phi_fu_140_p4;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] bound_fu_166_p0;
wire   [31:0] bound_fu_166_p1;
wire   [31:0] j_cast_fu_172_p1;
wire   [0:0] tmp_3_fu_176_p2;
wire   [30:0] i_s_fu_192_p2;
wire   [30:0] j_op_fu_238_p2;
reg   [2:0] ap_NS_fsm;
wire    ap_CS_fsm_state5;
reg    ap_block_state5;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [63:0] bound_fu_166_p00;
wire   [63:0] bound_fu_166_p10;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_reg_262 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_reg_136 <= i_cast1_mid2_v_reg_271;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        i_reg_136 <= 31'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_181_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten_reg_125 <= indvar_flatten_next_fu_186_p2;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        bound_reg_257 <= bound_fu_166_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond_flatten_reg_262 <= exitcond_flatten_fu_181_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_181_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_cast1_mid2_v_reg_271 <= i_cast1_mid2_v_fu_198_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_A == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_A <= tmp_data_V_reg_280;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_B == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_B <= tmp_data_V_reg_280;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_dest_V_1_load_A == 1'b1)) begin
        m_axis_video_V_dest_V_1_payload_A <= tmp_dest_V_reg_310;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_dest_V_1_load_B == 1'b1)) begin
        m_axis_video_V_dest_V_1_payload_B <= tmp_dest_V_reg_310;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_id_V_1_load_A == 1'b1)) begin
        m_axis_video_V_id_V_1_payload_A <= tmp_id_V_reg_305;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_id_V_1_load_B == 1'b1)) begin
        m_axis_video_V_id_V_1_payload_B <= tmp_id_V_reg_305;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_keep_V_1_load_A == 1'b1)) begin
        m_axis_video_V_keep_V_1_payload_A <= tmp_keep_V_reg_285;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_keep_V_1_load_B == 1'b1)) begin
        m_axis_video_V_keep_V_1_payload_B <= tmp_keep_V_reg_285;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_A == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_A <= tmp_last_V_reg_300;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_B == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_B <= tmp_last_V_reg_300;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_strb_V_1_load_A == 1'b1)) begin
        m_axis_video_V_strb_V_1_payload_A <= tmp_strb_V_reg_290;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_strb_V_1_load_B == 1'b1)) begin
        m_axis_video_V_strb_V_1_payload_B <= tmp_strb_V_reg_290;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_A == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_A <= tmp_user_V_reg_295;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_B == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_B <= tmp_user_V_reg_295;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_181_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_data_V_reg_280 <= s_axis_video_V_data_V_0_data_out;
        tmp_dest_V_reg_310 <= s_axis_video_V_dest_V_0_data_out;
        tmp_id_V_reg_305 <= s_axis_video_V_id_V_0_data_out;
        tmp_keep_V_reg_285 <= s_axis_video_V_keep_V_0_data_out;
        tmp_last_V_reg_300 <= s_axis_video_V_last_V_0_data_out;
        tmp_reg_276 <= tmp_fu_206_p1;
        tmp_strb_V_reg_290 <= s_axis_video_V_strb_V_0_data_out;
        tmp_user_V_reg_295 <= s_axis_video_V_user_V_0_data_out;
    end
end

always @ (*) begin
    if ((exitcond_flatten_fu_181_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_reg_262 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_i_phi_fu_140_p4 = i_cast1_mid2_v_reg_271;
    end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (tmp_reg_276_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (tmp_reg_276 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_reg_276 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_fu_181_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_181_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_181_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_flatten_fu_181_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_181_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_181_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((exitcond_flatten_fu_181_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((tmp_reg_276 == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((tmp_reg_276_pp0_iter1_reg == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end
...
assign bound_fu_166_p0 = bound_fu_166_p00;

assign bound_fu_166_p00 = hsize_in;

assign bound_fu_166_p1 = bound_fu_166_p10;

assign bound_fu_166_p10 = vsize_in;

assign bound_fu_166_p2 = (bound_fu_166_p0 * bound_fu_166_p1);

assign exitcond_flatten_fu_181_p2 = ((indvar_flatten_reg_125 == bound_reg_257) ? 1'b1 : 1'b0);

assign i_cast1_mid2_v_fu_198_p3 = ((tmp_3_fu_176_p2[0:0] === 1'b1) ? ap_phi_mux_i_phi_fu_140_p4 : i_s_fu_192_p2);

assign i_s_fu_192_p2 = (31'd1 + ap_phi_mux_i_phi_fu_140_p4);

assign indvar_flatten_next_fu_186_p2 = (indvar_flatten_reg_125 + 64'd1);

assign j_1_fu_244_p3 = ((tmp_3_fu_176_p2[0:0] === 1'b1) ? j_op_fu_238_p2 : 31'd1);

assign j_cast_fu_172_p1 = j_reg_147;

assign j_op_fu_238_p2 = (j_reg_147 + 31'd1);
...
assign tmp_3_fu_176_p2 = (($signed(j_cast_fu_172_p1) < $signed(hsize_in)) ? 1'b1 : 1'b0);

assign tmp_fu_206_p1 = i_cast1_mid2_v_fu_198_p3[0:0];
