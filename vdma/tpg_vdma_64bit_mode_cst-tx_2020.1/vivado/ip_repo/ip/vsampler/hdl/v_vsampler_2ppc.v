...
(* CORE_GENERATION_INFO="vsampler,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu2cg-sfvc784-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.880000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=406,HLS_SYN_LUT=891,HLS_VERSION=2018_3}" *)

module v_vsampler_2ppc #
(
    parameter NUM_VIDEO_COMPONENTS = 3,
    parameter SAMPLES_PER_CLOCK = 2,
...
reg   [0:0] tmp_5_reg_338;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] tmp_5_reg_338_pp0_iter1_reg;
reg   [63:0] indvar_flatten_reg_131;
reg   [30:0] i_reg_142;
reg   [30:0] j_reg_153;
wire   [31:0] tmp_fu_212_p3;
reg   [31:0] tmp_reg_314;
wire    ap_CS_fsm_state1;
wire   [63:0] bound_fu_228_p2;
reg   [63:0] bound_reg_319;
reg   [0:0] exitcond_flatten_reg_324;
...
wire   [63:0] indvar_flatten_next_fu_248_p2;
wire   [30:0] i_cast1_mid2_v_fu_260_p3;
reg   [30:0] i_cast1_mid2_v_reg_333;
wire   [0:0] tmp_5_fu_268_p1;
reg   [M_AXIS_WIDTH-1:0] tmp_data_V_reg_342;
reg   [M_AXIS_BYTES -1:0] tmp_keep_V_reg_347;
reg   [M_AXIS_BYTES -1:0] tmp_strb_V_reg_352;
reg   [0:0] tmp_user_V_reg_357;
reg   [0:0] tmp_last_V_reg_362;
reg   [0:0] tmp_id_V_reg_367;
reg   [0:0] tmp_dest_V_reg_372;
wire   [30:0] j_1_fu_306_p3;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [30:0] ap_phi_mux_i_phi_fu_146_p4;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] p_neg_fu_172_p2;
wire   [30:0] p_lshr_fu_178_p4;
wire   [31:0] tmp_1_fu_188_p1;
wire   [30:0] p_lshr_f_fu_198_p4;
wire   [0:0] tmp_3_fu_164_p3;
wire   [31:0] p_neg_t_fu_192_p2;
wire   [31:0] tmp_2_fu_208_p1;
wire   [31:0] bound_fu_228_p0;
wire   [31:0] bound_fu_228_p1;
wire   [31:0] j_cast_fu_234_p1;
wire   [0:0] tmp_4_fu_238_p2;
wire   [30:0] i_s_fu_254_p2;
wire   [30:0] j_op_fu_300_p2;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_reg_324 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_reg_142 <= i_cast1_mid2_v_reg_333;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        i_reg_142 <= 31'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_243_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten_reg_131 <= indvar_flatten_next_fu_248_p2;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        indvar_flatten_reg_131 <= 64'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_243_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_reg_153 <= j_1_fu_306_p3;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        j_reg_153 <= 31'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        bound_reg_319 <= bound_fu_228_p2;
        tmp_reg_314 <= tmp_fu_212_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond_flatten_reg_324 <= exitcond_flatten_fu_243_p2;
        tmp_5_reg_338_pp0_iter1_reg <= tmp_5_reg_338;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_243_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_cast1_mid2_v_reg_333 <= i_cast1_mid2_v_fu_260_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_A == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_A <= tmp_data_V_reg_342;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_data_V_1_load_B == 1'b1)) begin
        m_axis_video_V_data_V_1_payload_B <= tmp_data_V_reg_342;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_dest_V_1_load_A == 1'b1)) begin
        m_axis_video_V_dest_V_1_payload_A <= tmp_dest_V_reg_372;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_dest_V_1_load_B == 1'b1)) begin
        m_axis_video_V_dest_V_1_payload_B <= tmp_dest_V_reg_372;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_id_V_1_load_A == 1'b1)) begin
        m_axis_video_V_id_V_1_payload_A <= tmp_id_V_reg_367;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_id_V_1_load_B == 1'b1)) begin
        m_axis_video_V_id_V_1_payload_B <= tmp_id_V_reg_367;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_keep_V_1_load_A == 1'b1)) begin
        m_axis_video_V_keep_V_1_payload_A <= tmp_keep_V_reg_347;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_keep_V_1_load_B == 1'b1)) begin
        m_axis_video_V_keep_V_1_payload_B <= tmp_keep_V_reg_347;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_A == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_A <= tmp_last_V_reg_362;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_B == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_B <= tmp_last_V_reg_362;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_strb_V_1_load_A == 1'b1)) begin
        m_axis_video_V_strb_V_1_payload_A <= tmp_strb_V_reg_352;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_strb_V_1_load_B == 1'b1)) begin
        m_axis_video_V_strb_V_1_payload_B <= tmp_strb_V_reg_352;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_A == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_A <= tmp_user_V_reg_357;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_B == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_B <= tmp_user_V_reg_357;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_243_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_5_reg_338 <= tmp_5_fu_268_p1;
        tmp_data_V_reg_342 <= s_axis_video_V_data_V_0_data_out;
        tmp_dest_V_reg_372 <= s_axis_video_V_dest_V_0_data_out;
        tmp_id_V_reg_367 <= s_axis_video_V_id_V_0_data_out;
        tmp_keep_V_reg_347 <= s_axis_video_V_keep_V_0_data_out;
        tmp_last_V_reg_362 <= s_axis_video_V_last_V_0_data_out;
        tmp_strb_V_reg_352 <= s_axis_video_V_strb_V_0_data_out;
        tmp_user_V_reg_357 <= s_axis_video_V_user_V_0_data_out;
    end
end

always @ (*) begin
    if ((exitcond_flatten_fu_243_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_reg_324 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_i_phi_fu_146_p4 = i_cast1_mid2_v_reg_333;
    end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (tmp_5_reg_338_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (tmp_5_reg_338 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_5_reg_338 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_fu_243_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_243_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (exitcond_flatten_fu_243_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_flatten_fu_243_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_243_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_fu_243_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((exitcond_flatten_fu_243_p2 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((tmp_5_reg_338 == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((tmp_5_reg_338_pp0_iter1_reg == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end
...
assign bound_fu_228_p00 = tmp_fu_212_p3;

assign bound_fu_228_p1 = bound_fu_228_p10;

assign bound_fu_228_p10 = vsize_in;

assign bound_fu_228_p2 = (bound_fu_228_p0 * bound_fu_228_p1);

assign exitcond_flatten_fu_243_p2 = ((indvar_flatten_reg_131 == bound_reg_319) ? 1'b1 : 1'b0);

assign i_cast1_mid2_v_fu_260_p3 = ((tmp_4_fu_238_p2[0:0] === 1'b1) ? ap_phi_mux_i_phi_fu_146_p4 : i_s_fu_254_p2);

assign i_s_fu_254_p2 = (31'd1 + ap_phi_mux_i_phi_fu_146_p4);

assign indvar_flatten_next_fu_248_p2 = (indvar_flatten_reg_131 + 64'd1);

assign j_1_fu_306_p3 = ((tmp_4_fu_238_p2[0:0] === 1'b1) ? j_op_fu_300_p2 : 31'd1);

assign j_cast_fu_234_p1 = j_reg_153;

assign j_op_fu_300_p2 = (j_reg_153 + 31'd1);
...
assign p_lshr_f_fu_198_p4 = {{hsize_in[31:1]}};

assign p_lshr_fu_178_p4 = {{p_neg_fu_172_p2[31:1]}};

assign p_neg_fu_172_p2 = (32'd0 - hsize_in);

assign p_neg_t_fu_192_p2 = (32'd0 - tmp_1_fu_188_p1);
...
assign tmp_1_fu_188_p1 = p_lshr_fu_178_p4;

assign tmp_2_fu_208_p1 = p_lshr_f_fu_198_p4;

assign tmp_3_fu_164_p3 = hsize_in[32'd31];

assign tmp_4_fu_238_p2 = (($signed(j_cast_fu_234_p1) < $signed(tmp_reg_314)) ? 1'b1 : 1'b0);

assign tmp_5_fu_268_p1 = i_cast1_mid2_v_fu_260_p3[0:0];

assign tmp_fu_212_p3 = ((tmp_3_fu_164_p3[0:0] === 1'b1) ? p_neg_t_fu_192_p2 : tmp_2_fu_208_p1);
