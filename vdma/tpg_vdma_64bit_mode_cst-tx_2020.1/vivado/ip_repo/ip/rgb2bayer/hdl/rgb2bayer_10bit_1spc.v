...
(* CORE_GENERATION_INFO="rgb2bayer,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=389,HLS_SYN_LUT=813,HLS_VERSION=2018_3}" *)

module rgb2bayer_10bit_1spc (
        ap_clk,
        ap_rst_n,
        s_axis_video_TDATA,
        s_axis_video_TVALID,
...
input  [1:0] pattern_V;
 ...
 reg    ap_rst_n_inv;
reg   [31:0] s_axis_video_V_data_V_0_data_out;
...
reg   [31:0] s_axis_video_V_data_V_0_payload_A;
reg   [31:0] s_axis_video_V_data_V_0_payload_B;
...
reg   [0:0] exitcond_flatten_reg_499;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] exitcond_flatten_reg_499_pp0_iter1_reg;
...
reg   [30:0] j_cast5_mid2_v_reg_508;
reg   [0:0] tmp_user_V_reg_519;
reg   [0:0] tmp_last_V_reg_524;
wire   [30:0] i_1_fu_456_p3;
...
wire   [15:0] video_o_data_V_3_fu_320_p3;
wire   [15:0] video_o_data_V_4_cas_fu_333_p1;
wire   [15:0] video_o_data_V_8_fu_342_p1;
wire   [15:0] video_o_data_V_2_fu_359_p3;
wire   [15:0] video_o_data_V_1_fu_380_p3;
wire   [15:0] video_o_data_V_2_cas_fu_393_p1;
wire   [15:0] video_o_data_V_6_fu_402_p1;
wire   [15:0] video_o_data_V_fu_419_p3;
wire   [15:0] video_o_data_V_5_fu_432_p1;
wire   [15:0] video_o_data_V_1_cas_fu_441_p1;
...
wire   [0:0] tmp_3_fu_270_p1;
wire   [9:0] grp_fu_200_p4;
wire   [11:0] grp_fu_209_p4;
wire   [15:0] tmp_11_fu_312_p1;
wire   [15:0] tmp_13_fu_316_p1;
wire   [15:0] tmp_s_fu_351_p1;
wire   [15:0] tmp_10_fu_355_p1;
wire   [15:0] tmp_6_fu_372_p1;
wire   [15:0] tmp_8_fu_376_p1;
wire   [15:0] tmp_7_fu_411_p1;
wire   [15:0] tmp_2_fu_415_p1;
wire   [30:0] i_op_fu_450_p2;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_reg_499 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_reg_178 <= j_cast5_mid2_v_reg_508;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        j_reg_178 <= 31'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        bound_reg_494 <= bound_fu_226_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond_flatten_reg_499 <= exitcond_flatten_fu_241_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_241_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_cast5_mid2_v_reg_508 <= j_cast5_mid2_v_fu_258_p3;
    end
end
...
always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_A == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_A <= tmp_last_V_reg_524;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_last_V_1_load_B == 1'b1)) begin
        m_axis_video_V_last_V_1_payload_B <= tmp_last_V_reg_524;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_A == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_A <= tmp_user_V_reg_519;
    end
end

always @ (posedge ap_clk) begin
    if ((m_axis_video_V_user_V_1_load_B == 1'b1)) begin
        m_axis_video_V_user_V_1_payload_B <= tmp_user_V_reg_519;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_524 <= s_axis_video_V_last_V_0_data_out;
        tmp_user_V_reg_519 <= s_axis_video_V_user_V_0_data_out;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_reg_499 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_j_phi_fu_182_p4 = j_cast5_mid2_v_reg_508;
    end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_reg_499_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_reg_499 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_state3_io = ((exitcond_flatten_reg_499 == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((exitcond_flatten_reg_499_pp0_iter1_reg == 1'd0) & (m_axis_video_V_data_V_1_ack_in == 1'b0));
end
...
always @ (*) begin
    ap_condition_1227 = ((pattern_V_read_read_fu_102_p2 == 2'd3) & (i_cast4_mid2_fu_274_p2 == 1'd0) & (tmp_fu_266_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_1230 = ((pattern_V_read_read_fu_102_p2 == 2'd3) & (i_cast4_mid2_fu_274_p2 == 1'd1) & (tmp_fu_266_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_1235 = ((pattern_V_read_read_fu_102_p2 == 2'd2) & (i_cast4_mid2_fu_274_p2 == 1'd0) & (tmp_fu_266_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_1239 = ((pattern_V_read_read_fu_102_p2 == 2'd2) & (i_cast4_mid2_fu_274_p2 == 1'd1) & (tmp_fu_266_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_1245 = ((pattern_V_read_read_fu_102_p2 == 2'd1) & (tmp_fu_266_p1 == 1'd1) & (i_cast4_mid2_fu_274_p2 == 1'd0));
end

always @ (*) begin
    ap_condition_1249 = ((pattern_V_read_read_fu_102_p2 == 2'd1) & (i_cast4_mid2_fu_274_p2 == 1'd1) & (tmp_fu_266_p1 == 1'd1));
end

always @ (*) begin
    ap_condition_1253 = ((pattern_V_read_read_fu_102_p2 == 2'd0) & (tmp_fu_266_p1 == 1'd1) & (i_cast4_mid2_fu_274_p2 == 1'd0));
end

always @ (*) begin
    ap_condition_1256 = ((pattern_V_read_read_fu_102_p2 == 2'd0) & (i_cast4_mid2_fu_274_p2 == 1'd1) & (tmp_fu_266_p1 == 1'd1));
end
...
assign exitcond_flatten_fu_241_p2 = ((indvar_flatten_reg_167 == bound_reg_494) ? 1'b1 : 1'b0);

assign grp_fu_200_p4 = {{s_axis_video_V_data_V_0_data_out[19:10]}};

assign grp_fu_209_p4 = {{s_axis_video_V_data_V_0_data_out[31:20]}};

assign i_1_fu_456_p3 = ((tmp_4_fu_236_p2[0:0] === 1'b1) ? i_op_fu_450_p2 : 31'd1);

assign i_cast4_mid2_fu_274_p2 = (tmp_4_fu_236_p2 & tmp_3_fu_270_p1);

assign i_cast_fu_232_p1 = i_reg_189;

assign i_op_fu_450_p2 = (i_reg_189 + 31'd1);
...
assign tmp_10_fu_355_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign tmp_11_fu_312_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign tmp_13_fu_316_p1 = grp_fu_209_p4;

assign tmp_2_fu_415_p1 = grp_fu_209_p4;

assign tmp_3_fu_270_p1 = i_reg_189[0:0];

assign tmp_4_fu_236_p2 = (($signed(i_cast_fu_232_p1) < $signed(hsize_in)) ? 1'b1 : 1'b0);

assign tmp_6_fu_372_p1 = grp_fu_209_p4;

assign tmp_7_fu_411_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign tmp_8_fu_376_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign tmp_fu_266_p1 = j_cast5_mid2_v_fu_258_p3[0:0];

assign tmp_s_fu_351_p1 = grp_fu_209_p4;

assign video_o_data_V_11_fu_294_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign video_o_data_V_1_cas_fu_441_p1 = grp_fu_200_p4;

assign video_o_data_V_1_fu_380_p3 = ((i_cast4_mid2_fu_274_p2[0:0] === 1'b1) ? tmp_6_fu_372_p1 : tmp_8_fu_376_p1);

assign video_o_data_V_2_cas_fu_393_p1 = grp_fu_200_p4;

assign video_o_data_V_2_fu_359_p3 = ((i_cast4_mid2_fu_274_p2[0:0] === 1'b1) ? tmp_s_fu_351_p1 : tmp_10_fu_355_p1);

assign video_o_data_V_3_fu_320_p3 = ((i_cast4_mid2_fu_274_p2[0:0] === 1'b1) ? tmp_11_fu_312_p1 : tmp_13_fu_316_p1);

assign video_o_data_V_4_cas_fu_333_p1 = grp_fu_200_p4;

assign video_o_data_V_5_fu_432_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign video_o_data_V_6_fu_402_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign video_o_data_V_7_cas_fu_303_p1 = grp_fu_200_p4;

assign video_o_data_V_8_fu_342_p1 = s_axis_video_V_data_V_0_data_out[15:0];

assign video_o_data_V_fu_419_p3 = ((i_cast4_mid2_fu_274_p2[0:0] === 1'b1) ? tmp_7_fu_411_p1 : tmp_2_fu_415_p1);
